      ...
      <div className="max-w-3xl mx-auto text-center w-full">
        ...
        <AnimatedSection delay={0.2}>
          <div className="mt-10 flex flex-col items-center gap-8">
            <PopupButton
              id="xjazXMlj"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-white text-black font-medium text-lg hover:bg-white/90 transition-colors cursor-pointer"
            >
              Contact Me
            </PopupButton>
